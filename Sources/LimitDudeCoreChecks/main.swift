...
private func runChecks() {
    ...
    expect(monitor.ingest(.warning(usagePercent: 90, resetText: "7:00 PM")) == .warning(.warning(usagePercent: 90, resetText: "7:00 PM")), "Crossing the 90 percent warning band must trigger warning animation")
    expect(monitor.ingest(.warning(usagePercent: 91, resetText: "7:00 PM")) == .none, "Repeated 90 percent warning band must not trigger again")
